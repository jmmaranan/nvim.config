...
jdtls:
	...
	curl -L https://www.eclipse.org/downloads/download.php?file=/jdtls/milestones/1.33.0/jdt-language-server-1.33.0-202402151717.tar.gz -o $(ECLIPSE_PATH)/eclipse.jdt.ls.tar.gz \
